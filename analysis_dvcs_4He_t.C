...
void analysis_dvcs_4He_t::Loop() 
{
  ...
  // 20 days at 1.5e34
      ...
      for(int i=0; i<n_con; i++)
      {
         ...
         hh_Q2[i] = new TH1D(Form("hh_Q2[%d]",i),"", 150, 0, 32.0);

         h_Q2_tt_Coh[i]  = new TH2D(Form("h_Q2_tt_Coh[%d]",i),"",150, 0.9, 32, 150, 0.0, 0.1);
         h_Q2_xB_Coh[i]  = new TH2D(Form("h_Q2_xB_Coh[%d]",i),"",150, 0.0, 0.1, 150, 0.9, 32);
