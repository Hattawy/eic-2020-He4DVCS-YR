...
for (Long64_t jentry=0; jentry<nentries;jentry++)
  {
    ...
    if (jentry% 100000 == 0) printf("still running %d \n",(int)jentry);
      ...
      // if (Cut(ientry) < 0) continue;
         ...
         if(jentry < N_e_exp1){
              ...
              h_Q2_xB_Coh[0]         ->Fill(xb, Q2);
              h_Q2_tt_Coh[0]         ->Fill( Q2,t);
         ...
         if(jentry < N_e_exp2){
              ...
              h_Q2_xB_Coh[1]         ->Fill(xb, Q2);
              h_Q2_tt_Coh[1]         ->Fill(Q2,t);
              if (which_xB != -1 && which_t != -1 )
               {
        ...
        if(jentry < N_e_exp3){
              ...
              h_Q2_xB_Coh[2]         ->Fill(xb, Q2);
              h_Q2_tt_Coh[2]         ->Fill(Q2,t);
              if (which_xB != -1 && which_t != -1 )
               {
    ...
    TCanvas *c66 = new TCanvas("c66","",650,550 );
     for(int ii=0; ii<n_con; ii++){
        ...
        c66->cd();
          ...
          c66->Print(Form("fig/png/coh_Q2_xB%d.png",ii));
          c66->Print(Form("fig/pdf/coh_Q2_xB%d.pdf",ii));
        ...
        c66->cd();
          ...
          c66->Print(Form("fig/png/coh_Q2_tt%d.png",ii));
          c66->Print(Form("fig/pdf/coh_Q2_tt%d.pdf",ii));
        ...
        c66->cd();
          ...
          c66->Print(Form("fig/png/coh_xB_%d.png",ii));
          c66->Print(Form("fig/pdf/coh_xB_%d.pdf",ii));
        ...
        c66->cd();
          ...
          c66->Print(Form("fig/png/coh_Q2_%d.png",ii));
          c66->Print(Form("fig/pdf/coh_Q2_%d.pdf",ii));
    ...
    TCanvas *c6 = new TCanvas("c6","",650,550 );
     for(int ii=0; ii<n_con; ii++){
        ...
        c6->cd();
          ...
          c6->Print(Form("fig/png/coh_t_xB%d.png",ii));
          c6->Print(Form("fig/pdf/coh_t_xB%d.pdf",ii));
         }
    ...
    for(int ii=0; ii<1; ii++){
       for(int jj=0; jj<n_xB; jj++){
          ...
          // c66->Print(Form("fig/slices/coh_Q2%d_%d_%d.png",ii,jj,kk));

          // h_t_xB_Coh[ii][jj][kk]->Draw();
          // c66->Print(Form("fig/slices/coh_xB%d_%d_%d.png",ii,jj,kk));

          // h_t_t_Coh[ii][jj][kk]->Draw();
          // c66->Print(Form("fig/slices/coh_t%d_%d_%d.png",ii,jj,kk));
   ...
   for(int ii=0; ii<1; ii++){
       ...
       for(int kk=0; kk<n_t; kk++){
        ...
        //Re_t_x_err[ii][jj][kk]  =  (myfit->GetParError(1)/myfit->GetParameter(1)) *abs(Re_CFF);
          ...
          if( jj==1 && kk==1 ) 
          {
             ...
             l2->Draw("same");
             l3->Draw("same");
             c66->Print("fig/png/BSA_Coherent_Phi_high_stat.png");
             c66->Print("fig/pdf/BSA_Coherent_Phi_high_stat.pdf");
          }
          ...
          if( jj==1 && kk==5 ) 
          {
             ...
             l2->Draw("same");
             l3->Draw("same");
             c66->Print("fig/png/BSA_Coherent_Phi_low_stat.png");
             c66->Print("fig/pdf/BSA_Coherent_Phi_low_stat.pdf");
          }
    ...
    c3->Print("fig/png/BSA_Coherent_Phi_t.png");
    c3->Print("fig/pdf/BSA_Coherent_Phi_t.pdf");
